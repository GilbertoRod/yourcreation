  ...
  return (
    <>
      ...
      <div className='services-container'>
        ...
        <Cardv2 image={event} title='EVENTS' sub='Bring creativity to your birthday party or social event with custom designs' desc="At Your Creation, we offer live airbrushing for events where guests can choose custom hats or shirts with 100% personalized designs. Whether it's a company event, social gathering, or birthday party, our on-the-spot creations add a unique and memorable touch to any occasion."/>
